...
#define OV2740_EXPOSURE_MIN_LINES           (uint16_t)4       // min lines
#define OV2740_EXPOSURE_MAX_LINES_MARGIN    (uint16_t)15      // margin for max exposure
#define OV2740_EXPOSURE_MAX_LINES           (uint16_t)2145    // max lines
...
#define OV2740_GAIN_MAX                     23805  // dBm
